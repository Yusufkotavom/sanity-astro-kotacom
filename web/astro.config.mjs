...
export default defineConfig({
  ...
  env: {
    schema: {
      ...
      SANITY_API_VERSION: envField.string({ context: 'server', access: 'public', optional: true }),
      SANITY_USE_CDN: envField.string({ context: 'server', access: 'public', optional: true }),
